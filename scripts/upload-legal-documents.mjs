...
const documents = [
  ...
  // },
  {
    slug: "regras_de_mandela",
    categoria: "tratados_internacionais",
    file: "public/json/tratados_internacionais/regras_de_mandela/regras_de_mandela.json",
    storagePath:
      "tratados_internacionais/regras_de_mandela/v1/regras_de_mandela.json",
  },
]
